...
- **Linux/macOS:**
   ...
   ```
- **<span>  <div style="display: flex; align-items: center;"><span>Windows:</span><a href="https://skillicons.dev"><img src="https://skillicons.dev/icons?i=windows&theme=light" alt="Windows" width="50px" height="50px" /></a><span>This text is aligned with the icon.</span></div> :** 
    - Command Prompt (CMD):
    ```

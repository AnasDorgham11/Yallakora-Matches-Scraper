...
- **Linux/macOS:**
   ...
   ```
- ** <span> Windows <a href="https://skillicons.dev"> <img src="https://skillicons.dev/icons?i=windows&theme=light" alt="Windows" width="25px" height="25px" style="vertical-align: text-bottom;" /> </a> </span> :** 
    - Command Prompt (CMD):
    ```

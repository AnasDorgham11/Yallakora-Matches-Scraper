...
- **Linux/macOS:**
   ...
   ```
- **Windows <span> <a href="https://skillicons.dev"> <img src="https://skillicons.dev/icons?i=windows&theme=light" alt="Windows" width="30px" height="40px" style="vertical-align: bottom;" /> </a> </span> :** 
    - Command Prompt (CMD):
    ```
